...
import { customModel } from 'ai-chatbot/lib/ai';
import { models } from 'ai-chatbot/lib/ai/models';
import { systemPrompt } from 'ai-chatbot/lib/ai/prompts';
import {
  deleteChatById,
  getChatById,
  getDocumentById,
...
export async function POST(request: Request) {
  ...
  const result = await streamText({
    ...
    tools: {
      ...
      createDocument: {
        description: 'Create an empty document for a writing activity',
        parameters: z.object({
          title: z.string(),
        }),
        execute: async ({ title }) => {
